...
class CapTableGenerator:
    ...
    def validate(self) -> bool:
        ...
        with self.performance_tracker.track("validation"):
            self.is_valid, self.validation_errors = validate_cap_table(
                self.data)
        return self.is_valid

    def generate_excel(self, output_path: str, force: bool = False, currency: str = "EUR") -> str:
        """
        ...
        with self.performance_tracker.track("excel_generation"):
            generator = ExcelGenerator(
                self.data, output_path, currency=currency)
